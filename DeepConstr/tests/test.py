...
def askAI(question, prompts, model="gpt-4o-mini"):
    """AI提问函数"""
    # 配置API
...
if __name__ == '__main__':
    prompts='你是一个相关领域的专家，请从专业真实客观的角度回答问题'
    question='计算机领域中的污点分析是什么？'
    askAI(question,prompts)
    pass

"""
/home/apulis-dev/code/DeepConstr/tests
"""